...
#DesignerProperty: Key: mWidth, DisplayName: Width, FieldType: String, DefaultValue: 100vw, List: | |auto |100%|100vw|, Description: width
#DesignerProperty: Key: mHeight, DisplayName: Height, FieldType: String, DefaultValue: , List: | |auto|100%|100vh|, Description: height
#DesignerProperty: Key: Classes, DisplayName: Classes, FieldType: String, DefaultValue: sdcontainer, Description: Classes added to the HTML tag.
