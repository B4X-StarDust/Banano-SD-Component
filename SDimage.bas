...
#DesignerProperty: Key: Source, DisplayName: Source, FieldType: String, DefaultValue: ./assets/, Description: Source image added to the HTML tag.
'alt
#DesignerProperty: Key: Classes, DisplayName: Classes, FieldType: String, DefaultValue: , Description: Classes added to the HTML tag.
#DesignerProperty: Key: Style, DisplayName: Style, FieldType: String, DefaultValue: , Description: Styles added to the HTML tag. Must be a json String.
#DesignerProperty: Key: MaxHeight, DisplayName: Max Height, FieldType: String, DefaultValue: , Description: Set max Height 100vh
#DesignerProperty: Key: MaxWidth, DisplayName: Max Width, FieldType: String, DefaultValue: , Description: Set max Width 100vw
...
Sub Class_Globals
	...
	Private mMaxWidth As String = "" 'ignore
...
Public Sub DesignerCreateView (Target As BANanoElement, Props As Map)
	...
	mElement = mTarget.Append($"<div id="div_${mName}" class="${mClasses}" style="${exStyle}${mStyle}"><img style="Height:${mMaxHeight};width:${mMaxWidth};" id="${mName}" src="${Source}"></div>"$).Get("#" & mName)
	'Dim be As BANanoElement = BANano.GetElement("#" & mName)
	'be.SetStyle($"{"max-height":"${mMaxHeight}"}"$)
...
public Sub BuildExStyle() As String
	...
	If mMaxWidth <> "" Then sb.Append("max-width: " & mMaxWidth & ";")
	If mMaxHeight <> "" Then sb.Append("max-height: " & mMaxHeight & ";")
	Return sb.ToString
End Sub
