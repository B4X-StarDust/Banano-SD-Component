...
#DesignerProperty: Key: urlVideo, DisplayName: Classes, FieldType: String, DefaultValue: ./assets/, Description: url video
...
Public Sub DesignerCreateView (Target As BANanoElement, Props As Map)
	...
	mElement = mTarget.Append($"<video id="vvideo1" controls="controls" preload="auto" class="" style="object-fit: cover; object-position: center center; border-radius: inherit; margin: 0px auto;${exStyle}"><source src="${urlVideo}" type="video/mp4"></video>"$).Get("#" & mName)
