...
#DesignerProperty: Key: mBackground, DisplayName: Background Color, FieldType: Color, DefaultValue: 0xFF32B0FF, Description: Background Color
...
Public Sub DesignerCreateView (Target As BANanoElement, Props As Map)
	...
	Dim exStyle As String = BuildExStyle 'ignore
	
	mElement = mTarget.Append($"
	<div id="divc_${mName}" style="max-width: 300px; overflow-x: auto; white-space: nowrap; border: 1px solid #ccc;">
        <div id="divsc_${mName}" style="display: inline-block; width: 600px; height: 100px; background-color: #f0f0f0;">
            Questo è un esempio di contenuto che si estende oltre la larghezza del contenitore, quindi avrà lo scorrimento orizzontale.
        </div>
	</div>"$).Get("#" & mName)
...
Public Sub setbackgroundColor(Color As String)
	Dim be As BANanoElement = BANano.GetElement("#divsc_" & mName)
