...
#DesignerProperty: Key: mHeight, DisplayName: Height, FieldType: String, DefaultValue: , Description: Height (px or %) of label - none for automatic
...
#DesignerProperty: Key: mAlignVert, DisplayName: Align V, FieldType: String, DefaultValue: center, List: flex-start|flex-end|center|baseline|stretcht, Description: Align Vertical
...
Public Sub DesignerCreateView (Target As BANanoElement, Props As Map)
	...
	mElement = mTarget.Append($"<div id="div_${mName}" class="${mClasses}" style="${exStyle}${mStyle}"><${mType} id="${mName}">${mText}</${mType}></div>"$).Get("#div_" & mName)
